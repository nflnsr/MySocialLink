    ...
    <div>
      <div className="">
        <Layout className="pointer-events-auto overflow-y-scroll [&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-400 dark:[&::-webkit-scrollbar-thumb]:bg-slate-700">
          ...
          <ChangeTheme className="mt-2 mb-5" />
          <div className="mb-10">
            <Chatbot className="mx-auto bg-gradient-to-br from-slate-400 via-slate-400 to-slate-400 dark:bg-gradient-to-br dark:from-sky-900 dark:via-sky-900 dark:to-sky-900" />
          </div>
        </Layout>
      </div>
    </div>
